        ...
        <div class="w-3/4">
            ...
            <div class="mb-6">
                <div class="flex items-end justify-between mb-2">
                    <p class="text-slate-600 w-full border-b dark:text-slate-100">Listing detail</p>
            ...
            <!--Contact info-->
            <div class="mb-6">
                <p class="text-slate-600 w-full border-b dark:text-slate-100 mb-2">
                    Contact info
                </p>
                <!--Email-->
                ...
                <div v-if="listing.link" class="flex items-center mb-2 gap-2">
                    ...
                    <p class="whitespace-nowrap">External Link:</p>
                    <a :href="listing.link" target="_blank" class="text-link break-all max-w-xs truncate">
                        {{ listing.link }}
                    </a>
                </div>
                <!--User-->
            ...
            <div v-if="listing.tags" class="mb-6">
                <p class="text-slate-600 w-full border-b dark:text-slate-100 mb-2">Tags</p>
